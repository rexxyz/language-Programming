...
cv2.putText(image, "Clock in OpenCV", (175, 205), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
cv2.putText(image, "using Python", (210, 250), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
