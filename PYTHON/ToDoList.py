...
entry_button=Button(window,text="Add task",width=30,command=add)
entry_button.pack(pady=3)

delete_button=Button(window,text="Delete selected task",width=30,command=delete)
delete_button.pack(pady=3)

mark_button=Button(window,text="Mark as completed ",width=30,command=completed)
